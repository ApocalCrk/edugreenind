...
@section('title', 'Kategori Post | Edu Green')
            ...
            <table class="table" id="dataKategori">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $row->aktif }}</td>
                        <td>
                            <a href="/admin/kategori/{{ $row->id }}/edit" class="badge badge-warning"> <i class="fa fa-edit"></i> Edit</a>
                            @if($row->id != 3)
                            <form action="/admin/kategori/{{ $row->id }}" method="post" class="d-inline form-delete{{ $row->id }}">
                                @csrf
                                @method('delete')
...
<div class="modal fade" id="TambahModal" tabindex="-1" role="dialog" aria-labelledby="TambahModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
          <form action="/admin/kategori" method="post" id="form-tambah">
              @csrf
              <div class="form-group">
                  <label for="nama_kategori">Nama Kategori</label>
                  <input type="text" name="nama_kategori" id="nama_kategori" placeholder="Masukkan Nama Kategori" class="form-control @error('nama_kategori') is-invalid @enderror" value="{{ old('nama_kategori') }}">
                  @error('nama_kategori')
