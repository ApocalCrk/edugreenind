...
@section('title', 'Fitur Beranda | Edu Green')
    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-header">
            <a data-toggle="modal" id="tambah" data-target="#TambahModal" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Fitur </a>
        </div>
        <div class="card-body">
            ...
            <table class="table" id="dataMenu">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $row->deskripsi }}</td>
                        <td>
                            <a href="/admin/homeline/{{ $row->id }}/edit" class="badge badge-warning"> <i class="fa fa-edit"></i> Edit</a>
                            <form action="/admin/homeline/{{ $row->id }}" method="post" class="d-inline form-delete{{ $row->id }}">
                                @csrf
                                @method('delete')
                                <a style="cursor:pointer;color: #fff" onclick="delete_function(id)" class="badge badge-danger"> <i class="fa fa-trash"></i> Delete</a>
                            </form>
                        </td>
                    </tr>
                    @endforeach
...
<div class="modal fade" id="TambahModal" tabindex="-1" role="dialog" aria-labelledby="TambahModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-header">
          <h5 class="modal-title" id="TambahModalLabel">Tambah Fitur Beranda</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
          </button>
      </div>
      <div class="modal-body">
          <form action="/admin/homeline" method="post" id="form-tambah" enctype="multipart/form-data">
              @csrf
