...
@section('title', 'Tambah Halaman Statis | Edu Green')
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card-header">
        ...
        <div class="card-body">
            <form action="/admin/halamanstatis" id="form-tambah" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="judul">Judul</label>
                    <input type="text" name="judul" id="judul" placeholder="Masukkan Judul Halaman" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul') }}">
                    @error('judul')
                ...
                <div class="form-group">
                    ...
                    <textarea id="isi_halaman" name="isi_halaman" class="@error('isi_halaman') is-invalid @enderror">{{old('isi_halaman')}}</textarea>
                    @error('isi_halaman')
                    <div class="invalid-tooltip">
                        {{ $message }}
                    </div>
