                        ...
                        <div class="news-post-thumb">
                            <div class="img informasi-img">
                                ...
                                <div class="text">
                                    ...
                                    <a class="text-light"><i class="fa fa-list-alt"></i> {{ $row->tgl_mulai }} &nbsp; <i class="fa fa-clock-o"></i> {{$row->jam}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="populer-thumb col-lg-12 col-md-6 col-sm-12">
                        ...
                        <div class="text-populer">
                            <h5 style="text-overflow: ellipsis;overflow: hidden"><a href="/post/{{$row->judul_seo}}" class="text-light" style="width: 70px;text-overflow: ellipsis;overflow: hidden;white-space: nowrap;">{{ $row->tema }}</a></h5>
